...
export function ReportSave(state) {
  document.getElementById('explorerPanel').innerHTML =
    ...
    + encodeURIComponent(ReportMasBall1) +
    '" download="Reports-analiz-ball1.txt">Сохранить отчёты  c баллом=1 по сборнику в файл</a><br>' +
    '<a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportMasBall2) + '" download="Reports-analiz-ball2.txt">' +
    'Сохранить отчёты c баллом=2 по сборнику в файл</a><br><a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportMasBall3)
    ...
    + encodeURIComponent(ReportAccent) + '" download="Reports-Accent-all.txt">Сохранить весь сборник с расставленными ударениями в файл</a>' +
    '<br><a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportAccentBall0)
    + '" download="Reports-Accent-ball0.txt">Сохранить сборник стихов с баллом=0 с расставленными ударениями в файл</a>' +
    '<br><a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportAccentBall1) + '" download="Reports-Accent-ball1.txt">' +
    'Сохранить сборник стихов с баллом=1 с расставленными ударениями в файл</a><br>' +
    '<a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportAccentBall2) + '" download="Reports-Accent-ball2.txt">' +
    'Сохранить сборник стихов с баллом=2 с расставленными ударениями в файл</a><br>' +
    '<a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportAccentBall3) + '" download="Reports-Accent-ball3.txt">' +
    'Сохранить сборник стихов с баллом=3 с расставленными ударениями в файл</a><br>' +
    '<a href="data:text/plain;charset=utf-8,%EF%BB%BF' + encodeURIComponent(ReportTab) + '" download="Reports-csv.txt">Сохранить csv для загрузки в базу данных</a>' +
